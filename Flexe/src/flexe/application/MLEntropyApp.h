...
class MLEntropyApp : public DemoBaseApplLayer {
public:
...
protected:
    ...
    std::map<std::string, std::tuple<double, int>> datasetEntropyMap; //(dataset, <Entropy, Num of Examples>)
    ...
    //METRICS
    std::map<std::string, int> dataset2Number;
    simsignal_t datasetUsedUpdateMetric;
    simsignal_t datasetTrainUpdateMetric;
    simsignal_t datasetEvaluateUpdateMetric;
