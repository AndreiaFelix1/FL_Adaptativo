...
void MLApp::handleSelfMsg(cMessage* msg) {
    switch (msg->getKind()) {
        ...
        case TRAIN_LOCAL_MODEL_EVT: {
            ...
            flexe_msg->setSendTime(simTime().dbl());
            ...
            EV << "\n========== LOCAL MODEL SEND ==========\n";
            EV << "Vehicle      : " << self << "\n";
            EV << "Kind         : " << flexe_msg->getKind() << "\n";
            EV << "MsgID        : " << flexe_msg->getMsgId() << "\n";
            EV << "SenderID     : " << flexe_msg->getSenderID() << "\n";
            EV << "F1           : " << flexe_msg->getF1Score() << "\n";
            EV << "SendTime     : " << flexe_msg->getSendTime() << "\n";
            EV << "======================================\n";
