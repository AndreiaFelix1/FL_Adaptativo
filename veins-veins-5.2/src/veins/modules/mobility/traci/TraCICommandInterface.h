...
public:
    ...
    //CREATED BY WELL
    Coord convertPositionSumo2Veins(double x, double y, int rsuID);
    ...
    public:
        ...
        std::string getVehicleId(); //CREATED BY WELL
        std::list<std::string> getVehiclesIds(); //CREATED BY WELL
        Coord getVehiclePosition();//CREATED BY WELL
        double getMaxSpeed();
    ...
    // CREATED BY WELL: Person methods
    ...
    public:
        ...
        std::list<std::string> getPersonIds();
