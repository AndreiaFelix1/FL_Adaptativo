...
class ModelReply final :
 ...
 public:
  ...
  enum : int {
    ...
    kScenarioFieldNumber = 4,
    kMsgFieldNumber = 12,
    kConfusionMatrixFieldNumber = 19,
    kIdEntityFieldNumber = 1,
    kSeedFieldNumber = 5,
    kNonIIDFieldNumber = 6,
    kIdModelFieldNumber = 7,
    ...
    kMccFieldNumber = 13,
    kPrecisionFieldNumber = 14,
    kSpecificityFieldNumber = 15,
    kF1ScoreFieldNumber = 16,
    kSensitivityFieldNumber = 17,
    kRocAucFieldNumber = 18,
  ...
  // string confusionMatrix = 19;
  void clear_confusionmatrix();
  const std::string& confusionmatrix() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_confusionmatrix(ArgT0&& arg0, ArgT... args);
  std::string* mutable_confusionmatrix();
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_confusionmatrix();
  void set_allocated_confusionmatrix(std::string* confusionmatrix);
  private:
  const std::string& _internal_confusionmatrix() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_confusionmatrix(const std::string& value);
  std::string* _internal_mutable_confusionmatrix();
  public:
  ...
  void clear_mcc();
  double mcc() const;
  void set_mcc(double value);
  private:
  double _internal_mcc() const;
  void _internal_set_mcc(double value);
  public:
  ...
  // double specificity = 15;
  void clear_specificity();
  double specificity() const;
  void set_specificity(double value);
  private:
  double _internal_specificity() const;
  void _internal_set_specificity(double value);
  public:

  // double f1Score = 16;
  void clear_f1score();
  double f1score() const;
  void set_f1score(double value);
  private:
  double _internal_f1score() const;
  void _internal_set_f1score(double value);
  public:

  // double sensitivity = 17;
  ...
  void clear_rocauc();
  double rocauc() const;
  void set_rocauc(double value);
  private:
  double _internal_rocauc() const;
  void _internal_set_rocauc(double value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr scenario_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr msg_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr confusionmatrix_;
  ::PROTOBUF_NAMESPACE_ID::int32 identity_;
  ::PROTOBUF_NAMESPACE_ID::int32 seed_;
  bool noniid_;
  ::PROTOBUF_NAMESPACE_ID::int32 idmodel_;
...
// double mcc = 13;
inline void ModelReply::clear_mcc() {
  mcc_ = 0;
}
inline double ModelReply::_internal_mcc() const {
  return mcc_;
}
inline double ModelReply::mcc() const {
  // @@protoc_insertion_point(field_get:flexe.ModelReply.mcc)
  return _internal_mcc();
}
inline void ModelReply::_internal_set_mcc(double value) {
  
  mcc_ = value;
}
inline void ModelReply::set_mcc(double value) {
  _internal_set_mcc(value);
  // @@protoc_insertion_point(field_set:flexe.ModelReply.mcc)
}

// double precision = 14;
inline void ModelReply::clear_precision() {
  precision_ = 0;
}
inline double ModelReply::_internal_precision() const {
  return precision_;
}
inline double ModelReply::precision() const {
  // @@protoc_insertion_point(field_get:flexe.ModelReply.precision)
  return _internal_precision();
}
inline void ModelReply::_internal_set_precision(double value) {
  
  precision_ = value;
}
inline void ModelReply::set_precision(double value) {
  _internal_set_precision(value);
  // @@protoc_insertion_point(field_set:flexe.ModelReply.precision)
}

// double specificity = 15;
inline void ModelReply::clear_specificity() {
  specificity_ = 0;
}
inline double ModelReply::_internal_specificity() const {
  return specificity_;
}
inline double ModelReply::specificity() const {
  // @@protoc_insertion_point(field_get:flexe.ModelReply.specificity)
  return _internal_specificity();
}
inline void ModelReply::_internal_set_specificity(double value) {
  
  specificity_ = value;
}
inline void ModelReply::set_specificity(double value) {
  _internal_set_specificity(value);
  // @@protoc_insertion_point(field_set:flexe.ModelReply.specificity)
}

// double f1Score = 16;
inline void ModelReply::clear_f1score() {
  f1score_ = 0;
}
inline double ModelReply::_internal_f1score() const {
  return f1score_;
}
inline double ModelReply::f1score() const {
  // @@protoc_insertion_point(field_get:flexe.ModelReply.f1Score)
  return _internal_f1score();
}
inline void ModelReply::_internal_set_f1score(double value) {
  
  f1score_ = value;
}
inline void ModelReply::set_f1score(double value) {
  _internal_set_f1score(value);
  // @@protoc_insertion_point(field_set:flexe.ModelReply.f1Score)
}

// double sensitivity = 17;
inline void ModelReply::clear_sensitivity() {
  sensitivity_ = 0;
}
inline double ModelReply::_internal_sensitivity() const {
  return sensitivity_;
}
inline double ModelReply::sensitivity() const {
  // @@protoc_insertion_point(field_get:flexe.ModelReply.sensitivity)
  return _internal_sensitivity();
}
inline void ModelReply::_internal_set_sensitivity(double value) {
  
  sensitivity_ = value;
}
inline void ModelReply::set_sensitivity(double value) {
  _internal_set_sensitivity(value);
  // @@protoc_insertion_point(field_set:flexe.ModelReply.sensitivity)
}

// double rocAuc = 18;
inline void ModelReply::clear_rocauc() {
  rocauc_ = 0;
}
inline double ModelReply::_internal_rocauc() const {
  return rocauc_;
}
inline double ModelReply::rocauc() const {
  // @@protoc_insertion_point(field_get:flexe.ModelReply.rocAuc)
  return _internal_rocauc();
}
inline void ModelReply::_internal_set_rocauc(double value) {
  
  rocauc_ = value;
}
inline void ModelReply::set_rocauc(double value) {
  _internal_set_rocauc(value);
  // @@protoc_insertion_point(field_set:flexe.ModelReply.rocAuc)
}

// string confusionMatrix = 19;
inline void ModelReply::clear_confusionmatrix() {
  confusionmatrix_.ClearToEmpty();
}
inline const std::string& ModelReply::confusionmatrix() const {
  // @@protoc_insertion_point(field_get:flexe.ModelReply.confusionMatrix)
  return _internal_confusionmatrix();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ModelReply::set_confusionmatrix(ArgT0&& arg0, ArgT... args) {
 
 confusionmatrix_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:flexe.ModelReply.confusionMatrix)
}
inline std::string* ModelReply::mutable_confusionmatrix() {
  // @@protoc_insertion_point(field_mutable:flexe.ModelReply.confusionMatrix)
  return _internal_mutable_confusionmatrix();
}
inline const std::string& ModelReply::_internal_confusionmatrix() const {
  return confusionmatrix_.Get();
}
inline void ModelReply::_internal_set_confusionmatrix(const std::string& value) {
  
  confusionmatrix_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ModelReply::_internal_mutable_confusionmatrix() {
  
  return confusionmatrix_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ModelReply::release_confusionmatrix() {
  // @@protoc_insertion_point(field_release:flexe.ModelReply.confusionMatrix)
  return confusionmatrix_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void ModelReply::set_allocated_confusionmatrix(std::string* confusionmatrix) {
  if (confusionmatrix != nullptr) {
    
  } else {
    
  }
  confusionmatrix_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), confusionmatrix,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:flexe.ModelReply.confusionMatrix)
}
